 ...
 *   Pulsacion 3: hex = 0xEEEEEE si todo OK, 0xAAAAAA si fallo
 */
...
int main(void) {
    ...
    uint8_t color;
    if (n_ok == 3) {
        color = 1; /* verde: SDRAM OK */
    } else if (n_ok == 0 && r0 == r1 && r1 == r2) {
        color = 2; /* rojo: 3 lecturas iguales y mal => WRITE roto */
    } else if (n_ok == 0) {
        color = 3; /* azul: 3 distintas y mal => READ/addr */
    } else {
